...
static void sample_DecTest(void)
{
    ...
    unsigned char skbuf[] =
            {
                0xe2, 0x72, 0xc1, 0x2b, 0x87, 0xe5, 0xd2, 0xf9, /* .r.+.... */
                0x79, 0xf8, 0x82, 0xa1, 0x08, 0x00, 0x45, 0x00, /* y.....E. */
                0x00, 0x64, 0x00, 0x00, 0x40, 0x00, 0x40, 0x32, /* .d..@.@2 */
                0x26, 0x66, 0x0a, 0x00, 0x00, 0x01, 0x0a, 0x00, /* &f...... */
                0x00, 0x02, 0x00, 0x00, 0x10, 0x01, 0x00, 0x00, /* ........ */
                0x00, 0x01, 0x1e, 0xd0, 0xa0, 0xe2, 0x3d, 0x4a, /* ......=J */
                0xbd, 0x34, 0x2c, 0xdf, 0xe4, 0x49, 0xbd, 0x92, /* .4,..I.. */
                0x7a, 0xa2, 0x2d, 0x94, 0xf7, 0xf4, 0x5f, 0x11, /* z.-..._. */
                0x31, 0xea, 0xdd, 0x79, 0x92, 0xd3, 0x54, 0x71, /* 1..y..Tq */
                0x7d, 0x5f, 0x7d, 0xec, 0xee, 0x02, 0xa9, 0x5a, /* }_}....Z */
                0x5d, 0x14, 0x39, 0x36, 0x83, 0x9f, 0xb3, 0x44, /* ].96...D */
                0x52, 0x73, 0xa0, 0xb1, 0xe2, 0x06, 0x45, 0x19, /* Rs....E. */
                0x06, 0x2c, 0x18, 0x06, 0x59, 0xce, 0x98, 0x4a, /* .,..Y..J */
                0x57, 0x78, 0x28, 0xca, 0x84, 0x42, 0xa2, 0xe1, /* Wx(..B.. */
                0xdd, 0x4a                                      /* .J */
            };
    ...
    msg.u.rxsa_msg.ipaddr[0] = 0x0a000001;
    memcpy(msg.u.rxsa_msg.key, key, sizeof(key));
    memcpy(&msg.u.rxsa_msg.salt, salt, sizeof(salt));
    msg.u.rxsa_msg.iptbl_ind = 0;
    IPSec_Loop((intptr_t)&msg);
    ...
    msg.type = MSG_DEC;
    SET_FIELD(desc.desc0, sizeof(skbuf), 0, 0x1ffff);   /* set rx buf size */
    /* SET_FIELD(desc.desc5, 14, 0, 0x7f);                 /\* set L2LEN *\/ */
    /* SET_FIELD(desc.desc5, 20, 7, 0x1ff);                /\* set L3LEN *\/ */
    /* SET_FIELD(desc.desc5, 80, 16, 0xff);                /\* set L4LEN *\/ */
    /* SET_FLAG(desc.desc1, 2);                            /\* set TCP checksum offload enable *\/ */
    ...
    msg.u.dec_msg.desc->desc9 = skbuf;
    IPSec_Loop((intptr_t)&msg);
